...
writeAssembly (MulImmediate offset source target) = fold [delimeter, "imul", delimeter, writeImmediate offset, ", ", writeRegister source, ", ", writeRegister target]
writeAssembly (MulRegister source target) = fold [delimeter, "imul", delimeter, writeRegister source, ", ", writeRegister target]
writeAssembly (DivRegister divisor) = fold [delimeter, "idiv", delimeter, writeRegister divisor]
writeAssembly Cqo = fold [delimeter, "cqo"]
