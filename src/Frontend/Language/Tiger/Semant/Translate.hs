module Frontend.Language.Tiger.Semant.Translate where
...
import Frontend.Language.Tiger.LSyntax qualified as T
...
import Frontend.Language.Tiger.Semant.TypeCheck qualified as TC
